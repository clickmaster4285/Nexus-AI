...
export default function WhisperCoaching() {
   const [selectedAgent, setSelectedAgent] = useState(supervisorAgents.find(a => a.status === "On Call") || supervisorAgents[0]);
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 h-[calc(100vh-220px)] overflow-hidden">
         ...
         <Card className="xl:col-span-1 flex flex-col min-h-0 border-primary/10 shadow-md">
            <CardHeader className="p-4 bg-primary/5 border-b">
               <CardTitle className="text-sm font-black uppercase tracking-widest text-muted-foreground">Active Sessions</CardTitle>
            </CardHeader>
                  ...
                  {activeAgents.map((agent) => (
                     ...
                     >
                        ...
                        <Badge variant="outline" className={cn(
                           ...
                           agent.sentiment === "Positive" ? "text-green-600 border-green-200" : "text-red-600 border-red-200"
                        )}>
                           {agent.sentiment}
                        </Badge>
                     </div>
            ...
            <Card className="flex-1 border-primary/10 shadow-lg flex flex-col min-h-0 bg-linear-to-b from-card to-secondary/5">
               <CardHeader className="p-4 border-b flex flex-row items-center justify-between">
                  <div className="flex items-center gap-3">
                     ...
                     <div>
                        <CardTitle className="text-md font-black">Whisper Console: {selectedAgent.name}</CardTitle>
                        <p className="text-[10px] text-muted-foreground uppercase font-black tracking-tighter">Live Session Assistance</p>
                     </div>
                  </div>
               ...
               <CardContent className="p-6 flex flex-col gap-6 overflow-hidden flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <div className="p-4 rounded-2xl bg-muted/30 border border-primary/5 space-y-2">
                        ...
                        <p className="text-sm font-bold text-primary italic">&quot;Troubleshooting hardware warranty for Nexus Pro v4&quot;</p>
                     </div>
                        ...
                        {coachingSuggestions.map((sug) => (
                           ...
                           >
                              <div className="space-y-1 pr-4">
                                 <Badge variant="outline" className="text-[8px] font-black uppercase px-1 py-0 leading-none mb-1 border-primary/20 text-primary">
                              ...
                              <Button size="icon" variant="ghost" className="h-10 w-10 shrink-0 group-hover:bg-primary group-hover:text-primary-foreground transition-all shadow-sm">
