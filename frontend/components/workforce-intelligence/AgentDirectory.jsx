...
export default function AgentDirectory() {
   ...
   return (
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 h-[calc(100vh-220px)] overflow-hidden">
         ...
         {/* Main Profile View */}
         <Card className="xl:col-span-3 flex flex-col min-h-0 border-primary/10 shadow-xl overflow-y-auto">
            <CardContent className="p-8">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           {[
                              ...
                              <div key={stat.label} className="p-4 rounded-xl bg-card border shadow-sm space-y-2">
                           ...
                           {selectedAgent.skills.map((skill) => (
                              <div key={skill.queue} className="space-y-1.5">
                                 <div className="flex justify-between text-xs">
                                    ...
                                    <span className="text-muted-foreground font-mono">LVL {skill.level}/5</span>
                                 </div>
                  ...
                  <div className="space-y-6">
                     <div className="p-6 rounded-2xl bg-linear-to-br from-primary/10 via-background to-secondary/10 border border-primary/20 shadow-inner">
                        <h3 className="text-lg font-bold flex items-center gap-2 mb-4">
                           <Award className="h-5 w-5 text-primary" /> Achievements
                        </h3>
                        <div className="flex flex-wrap gap-2">
                           {selectedAgent.gamification.badges.map((badge) => (
                              <Badge key={badge} variant="secondary" className="px-3 py-1 bg-background/50 border-primary/20 text-primary font-bold">
                                 {badge}
                              </Badge>
                           ))}
                        </div>
                        <div className="mt-6 flex items-center justify-between">
                           ...
                           <div className="space-y-1 text-right">
                              <p className="text-[10px] uppercase font-bold text-muted-foreground">Current Streak</p>
                     ...
                     <Card className="border-red-500/10 bg-red-500/2">
                        <CardHeader className="p-4 pb-0">
                           <h3 className="text-sm font-bold flex items-center gap-2">
                              <Heart className="h-4 w-4 text-red-500" /> Wellbeing Score
                           </h3>
                        </CardHeader>
                           ...
                           <div className="flex items-center gap-6">
                              ...
                              <div className="flex-1 space-y-1">
                                 <div className="flex items-center gap-2">
                                    <span className="text-xs text-muted-foreground uppercase font-bold">Trend</span>
                                    <Badge variant="outline" className={cn(
                                       "text-[10px] font-bold px-2 py-0 border-transparent",
                                 ...
                                 <p className="text-xs font-bold">{selectedAgent.wellbeing.riskLevel} Burnout Risk</p>
