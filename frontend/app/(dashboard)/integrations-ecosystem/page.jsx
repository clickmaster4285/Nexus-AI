...
export default function IntegrationsAndEcosystemPage() {
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2">
          Module interface for Integrations & Ecosystem. Currently viewing {activeTab} tab.
        </p>
      </div>
      ...
      <div className="bg-card border rounded-lg p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-muted-foreground max-w-md">
          The full interface for Integrations & Ecosystem is currently being developed. 
