...
// M03 Components
import ScorecardBuilder from "@/components/qa-compliance/ScorecardBuilder";
import EvaluationReview from "@/components/qa-compliance/EvaluationReview";
import ComplianceMonitor from "@/components/qa-compliance/ComplianceMonitor";
import CoachingWorkflow from "@/components/qa-compliance/CoachingWorkflow";
...
export default function QACompliancePage() {
  ...
  const setActiveTab = (tab) => {
    router.push(`/qa-compliance?tab=${tab}`);
  };
