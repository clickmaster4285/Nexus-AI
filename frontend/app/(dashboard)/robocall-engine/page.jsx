...
export default function RobocallCampaignPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">Robocall Campaign</h1>
        <p className="text-muted-foreground mt-2">
          Module interface for Robocall Campaign. Currently viewing {activeTab} tab.
        </p>
      </div>
      ...
      <div className="bg-card border rounded-lg p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-muted-foreground max-w-md">
          The full interface for Robocall Campaign is currently being developed. 
