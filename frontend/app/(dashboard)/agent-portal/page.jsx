...
export default function AgentSelfServicePortalPage() {
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2">
          Module interface for Agent Self-Service Portal. Currently viewing {activeTab} tab.
        </p>
      </div>
      ...
      <div className="bg-card border rounded-lg p-12 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-muted-foreground max-w-md">
          The full interface for Agent Self-Service Portal is currently being developed. 
