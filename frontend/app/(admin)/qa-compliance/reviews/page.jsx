...
export default function EvaluationQueuePage() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full min-h-150 p-1">
        ...
        <Card className="flex flex-col flex-1 shadow-lg border-primary/20">
          <CardHeader className="pb-4 border-b bg-muted/30">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="icon" className="h-8 w-8" title="View Transcript">
          ...
          <CardContent className="flex-1 flex flex-col p-6 space-y-6">
            ...
            <div className="aspect-video bg-black rounded-xl relative group overflow-hidden border-2 border-primary/10 shadow-inner">
              ...
              <div className="absolute top-4 right-4 space-y-2 text-right">
                ...
                <Badge variant="outline" className="bg-black/50 text-gray-50 backdrop-blur-sm block mt-2">12:34</Badge>
              </div>
            </div>
      ...
      <div className="lg:col-span-7 space-y-6 overflow-y-auto">
        <Card className="shadow-lg h-full flex flex-col">
          ...
          <CardContent className="p-0 flex-1 flex flex-col">
            ...
            <div className="p-6 border-t bg-muted/10 space-y-4 flex-1">
              <div className="space-y-2">
