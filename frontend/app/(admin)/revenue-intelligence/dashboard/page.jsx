  ...
  return (
    <div className="space-y-6 p-1">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          <Card key={i} className="relative overflow-hidden group hover:shadow-lg transition-all border-primary/10 hover:border-primary/30 shadow-sm">
            <div className={cn(
              "absolute top-0 right-0 w-24 h-24 -mr-8 -mt-8 opacity-5 group-hover:scale-110 transition-transform rounded-full",
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center text-[10px] text-muted-foreground py-1 border-t border-dashed border-muted font-medium italic">
                <p>{stat.desc}</p>
              </div>
            </CardContent>
          </Card>
        ...
        <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 max-w-md text-center md:text-left">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Based on active upsell signals and current conversion trends, we project an additional <span className="font-bold text-foreground">$125k</span> in revenue by end of month.
            </p>
          </div>
