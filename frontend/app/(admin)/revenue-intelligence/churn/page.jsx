        ...
        <div className="lg:col-span-3 space-y-6">
              ...
              <Card key={i} className="group relative border-2 border-transparent hover:border-primary/20 transition-all overflow-hidden bg-card/50 backdrop-blur-sm shadow-sm">
                ...
                <CardHeader className="pb-3 bg-muted/20 border-b">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-[10px] font-medium">Condition: <span className="text-foreground">**{p.trigger}**</span></CardDescription>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardContent className="pt-4 space-y-4">
                  ...
                  <div className="pt-3 border-t flex items-center justify-between">
                    ...
                    <Badge className="text-[9px] h-4 bg-green-50 text-green-600 border-green-200 font-bold uppercase">ACTIVE</Badge>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <Card key={i} className="bg-card/50 shadow-sm border-primary/5">
